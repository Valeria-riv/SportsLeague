...
namespace SportsLeague.DataAccess.Context
{
    public class LeagueDbContext : DbContext
    {
        ...
        public DbSet<Sponsor> Sponsors => Set<Sponsor>(); //PARCIAL
        public DbSet<TournamentSponsor> TournamentSponsors => Set<TournamentSponsor>(); // PARCIAL
        public DbSet<Match> Matches => Set<Match>(); // FASE 4
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MatchResult>(entity =>
            {
                ...
                // HasOne().WithOne() con HasForeignKey<MatchResult>() y
                // HasIndex().IsUnique() crea la relación 1:1. Sin el índice único, sería 1:N.
            });
