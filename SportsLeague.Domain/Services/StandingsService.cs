...
public class StandingsService : IStandingsService
{
    ...
    public async Task<object> GetStandingsAsync(int tournamentId)
    {
        ...
        // El ToDictionary me sirve para crear un diccionario con clave MatchId y valor el MatchResult correspondiente,
        // Esto permite acceder rapidamente al resultado de un partido dado su ID sin tener que buscar en una lista cada vez
        var resultsByMatch = allResults.ToDictionary(r => r.MatchId); // Key : MatchId, Value: MatchResult
        ...
        var standings = tournamentTeams.Select(tt =>
        {
            ...
            //cuántos partidos tuvieron mas goles a favor (HomeGoals) que en contra (AwayGoals).|
    ...
    // GetTopScorersAsync - Tabla de goleadores en un torneo
    ...
    // GetCardStatsAsync - Ranking de tarjetas por jugador en un torneo
